...
public abstract class Hilt_CitiesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CitiesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CitiesFragment_GeneratedInjector) this.generatedComponent()).injectCitiesFragment(UnsafeCasts.<CitiesFragment>unsafeCast(this));
    }
  }
