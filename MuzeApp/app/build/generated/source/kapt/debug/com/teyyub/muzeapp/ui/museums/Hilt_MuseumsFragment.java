...
public abstract class Hilt_MuseumsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MuseumsFragment() {
    super();
  }

  Hilt_MuseumsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MuseumsFragment_GeneratedInjector) this.generatedComponent()).injectMuseumsFragment(UnsafeCasts.<MuseumsFragment>unsafeCast(this));
    }
  }
